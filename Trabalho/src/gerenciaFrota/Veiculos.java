...
public class Veiculos {
	...
	public static void cadastrarMotocicleta() {
		...
		String capacidadeTanque = JOptionPane.showInputDialog("Capacidade do tanque de combustivel: ");
		String freiosAbs = JOptionPane.showInputDialog("Possui freios Abs? ");
		String controleTracao = JOptionPane.showInputDialog("Possui controle de tracao? ");
		String pilotoAutomatico = JOptionPane.showInputDialog("Possui piloto automatico? ");
		String modoPilotagem = JOptionPane.showInputDialog("Modo de pilotagem: ");
		Motocicletas moto = new Motocicletas(marca, modelo, anoFabricacao, oModelo, renavam, capacidadeTanque,
	...
	public static void cadastrarVeiculosPassageiros() {
		...
		String direcaoHidraulica = JOptionPane.showInputDialog("Possui direcao hidraulica? ");
	...
	public static void cadastrarVeiculosCarga() {
		...
		String compartimentoCarga = JOptionPane.showInputDialog("Compartimento de carga: ");
	...
	public static void cadastrarCompacto() {
		...
		String arCondicionado = JOptionPane.showInputDialog("Possui ar-condicionado? ");
		String direcaoHidraulica = JOptionPane.showInputDialog("Possui direcao hidraulica? ");
		String cambioAutomatico = JOptionPane.showInputDialog("Possui cambio automatico? ");
	...
	public static void cadastrarSedan() {
		...
		String anoModelo = JOptionPane.showInputDialog("Ano do modelo: ");
		String renavam = JOptionPane.showInputDialog("Renavam: ");
		String capacidadeTanque = JOptionPane.showInputDialog("Capacidade do tanque de combust�vel: ");
		String arCondicionado = JOptionPane.showInputDialog("Possui ar-condicionado? ");
		String direcaoHidraulica = JOptionPane.showInputDialog("Possui dire��o hidr�ulica? ");
