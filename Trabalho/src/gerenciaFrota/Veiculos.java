...
public class Veiculos {
	protected String marca,
			...
			renavam,
			capacidadeTanque;
	static Veiculos[] veic = new Veiculos[0];
	...
	public static void cadastrarMotocicleta() {
		...
		String controleTracao = JOptionPane.showInputDialog("Possui controle de tra��o? ");
		String pilotoAutomatico = JOptionPane.showInputDialog("Possui piloto autom�tico? ");
	...
	public static void cadastrarVeiculosPassageiros() {
		...
		String renavam = JOptionPane.showInputDialog("Renavam: ");
		String capacidadeTanque = JOptionPane.showInputDialog("Capacidade do tanque de combust�vel: ");
		String numeroOcupantes = JOptionPane.showInputDialog("N�mero de ocupantes: ");
