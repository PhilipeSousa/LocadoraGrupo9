...
public class Locatario {
	...
	public static void cadastrarPessoaFisica() {
		...
		PessoaFisica pfs = new PessoaFisica(nome, estadoCivil, cpf, email, telefone);
		pfs.setEndereco(new Endereco(cidade1, estado1, rua1, numero1, complemento1, bairro1, cep1));
	...
	public static void cadastrarPessoaJuridica() {
		...
		String email = JOptionPane.showInputDialog("E-mail: ");
		String telefone = JOptionPane.showInputDialog("Telefone: ");
		PessoaJuridica pjs = new PessoaJuridica(cnpj, nomeSocial, email, telefone);	
